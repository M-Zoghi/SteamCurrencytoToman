...
function LoadIRSteam(irsteamobject) {
    ...
    console.log("%c[USDtoToman] " + "%cIranian Steam Key Price: " + irsteamkeypriceglobal + " Toman", "color:#2196F3; font-weight:bold;", "color:null");
    console.log("%c[USDtoToman] " + "%cIranian Steam Key Quantity: " + irsteamkeyquantityglobal, "color:#2196F3; font-weight:bold;", "color:null");
...
function LoadMarketSteam(marketsteamobject) {
    ...
    console.log("%c[USDtoToman] " + "%cMarket Price: $" + marketsteamkeypriceglobal, "color:#2196F3; font-weight:bold;", "color:null");
