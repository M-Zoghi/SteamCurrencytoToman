...
function LoadIRSteam(irsteamobject) {
    ...
    console.log("%c[EURtoToman] " + "%cIranian Steam Key Price: " + irsteamkeypriceglobal + " Toman", "color:#2196F3; font-weight:bold;", "color:null");
    console.log("%c[EURtoToman] " + "%cIranian Steam Key Quantity: " + irsteamkeyquantityglobal, "color:#2196F3; font-weight:bold;", "color:null");
...
function LoadDragonSteam(dragonsteamobject) {
    ...
    console.log("%c[EURtoToman] " + "%cDragon Steam Key Price: " + dragonsteamkeypriceglobal + " Toman", "color:#2196F3; font-weight:bold;", "color:null");
...
function LoadMarketSteam(marketsteamobject) {
    ...
    console.log("%c[EURtoToman] " + "%cMarket Price: " + marketsteamkeypriceglobal + "€", "color:#2196F3; font-weight:bold;", "color:null");
